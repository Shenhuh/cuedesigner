    ...
    document.getElementById('butt-cap-material').addEventListener("change", function(event){
            ...
            switch (event.target.value) {
                ...
                case "white":
                    ...
                    currentDimension.w = 447;
                    currentDimension.h = 100;
                    addImageToPart.addImageToPart(white, currentDimension.w, currentDimension.h, currentPosition.y, currentPosition.x, `butt-cap`, 'butt-cap');
                    break;
                case "bone":
                    currentPosition.y = 3990;
                    currentDimension.w = 447;
                    currentDimension.h = 100;
                    addImageToPart.addImageToPart(bone, currentDimension.w, currentDimension.h, currentPosition.y, currentPosition.x, `butt-cap`, 'butt-cap');
                    break;
                case "stainless":
                    currentPosition.y = 3990;
                    currentDimension.w = 447;
                    currentDimension.h = 100;
                    addImageToPart.addImageToPart(stainless, currentDimension.w, currentDimension.h, currentPosition.y, currentPosition.x, `butt-cap`, 'butt-cap');
                    break;
