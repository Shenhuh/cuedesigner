...
<div class="container">
    <div class="container mt-4">
        <div class="card box rounded-3 dashboard-top-card h-100 d-flex flex-column"> <!-- Card with rounded corners -->
            <div class="card-body d-flex flex-column">
                ...
                <div class="table-responsive mt-3">
                    <table class="table table-modern table-hover" id="ongoing-orders">
                        <thead>
                            <tr>
        ...
        <div class="card box rounded-3 dashboard-top-card h-100 d-flex flex-column mt-4"> <!-- Card with rounded corners -->
            <div class="card-body d-flex flex-column">
                <div class="d-flex justify-content-between align-items-center"> <!-- Flex container for title and search -->
                    <h6 class="card-title mb-0">
  ...
  <button class="btn btn-primary mt-4">
    <i class="bi bi-eye me-2" style="color: white !important;"></i>
    View Archived
  </button>
</div>
